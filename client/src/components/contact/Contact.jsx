...
<div className="container my-32 mx-auto md:px-6">
  ...
  <section className="mb-32 p-16">
    <div
      className="block border p-4 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-50">
          ...
          <div className="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
              <div className="flex items-start">
                ...
                <div className="ml-6 grow">
                  <p className="mb-2 font-bold dark:text-neutral-900">
                    Technical support
                  </p>
            ...
            <div
              ...
              <div className="align-start flex">
                ...
                <div className="ml-6 grow">
                  <p className="mb-2 font-bold dark:text-neutral-900">Press</p>
                  <p className="text-neutral-700 dark:text-neutral-400">
                    press@example.com
                  </p>
                  <p className="text-neutral-700 dark:text-neutral-400">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
              <div className="align-start flex">
                ...
                <div className="ml-6 grow">
                  <p className="mb-2 font-bold dark:text-neutral-900">Bug report</p>
